                  ...
                  children: <Widget>[
                    RichText(
                        ...
                        text: TextSpan(children: [
                          TextSpan(
                            text:
                                "\n\nThank you for your purchase. If you have any questions or feedback, please don’t hesitate to reach out.",
                            style: CustomTextStyle.textFormFieldMedium.copyWith(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              createAddressText(
                  "431, CStreeat,Nairobi Kenya", 16),
              createAddressText("Room 405", 6),
              SizedBox(
                height: 6,
              ),
              RichText(
        ...
        children: <Widget>[
          ...
          FlatButton(
            ...
            child: Text(
              "Change",
              style: CustomTextStyle.textFormFieldSemiBold
                  .copyWith(fontSize: 12, color: AppColors.PrimaryDarkColor),
            ),
  ...
  standardDelivery() {
    return Container(
      decoration: BoxDecoration(
          borderRadius: BorderRadius.all(Radius.circular(4)),
          border:
              Border.all(color: AppColors.colorAccent.withOpacity(0.4), width: 1),
